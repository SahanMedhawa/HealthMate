...
// Add navigation items for authenticated patients
const patientNavItems = [
  { name: 'Dashboard', path: '/patient/dashboard' },
  { name: 'Find Doctors', path: '/doctorsdir' },
  { name: 'My Appointments', path: '/my-appointments' },
  { name: 'Medical Reports', path: '/patient/reports' },
  { name: 'Medical Dashboard', path: '/patient/dashboard' },
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-2xl z-50 border border-gray-100 overflow-hidden">
                    ...
                    {/* Menu */}
                    <div className="py-2">
                      {/* Dynamic patient navigation items */}
                      {patientNavItems.map((item) => (
                        ...
                        >
                          ...
                          {item.name === 'Medical Reports' && (
                            <svg className="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                          )}
                          {item.name === 'Medical Dashboard' && (
                            <svg className="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
